...
import com.example.demo.controller.WeixinController;
...
public class DemoApplicationTests {
	...
	public void uploadFodderController() throws IOException {
		...
		//缩略图id
		js.put("thumb_media_id","BldV_EtjAbyWVc0DJBXU_NKLhbLF7m3bCIZq6sxlRVQmGSxJXEK5bg1-SqfJBF49");
		js.put("title","11111");
		jsonlist.add(js);
		...
		System.out.println(jsonImageText);
		...
		jsonNews.put("media_id","2qM0Vofyi7Idx3CHokCJizLWL5tlrMQ8hTGCsnNq9IqFMeDz15fu27Cwd3K9WuuF");
